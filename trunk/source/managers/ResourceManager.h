...
//
// Desc: ResourceManager class is a virtual template manager
//
...
*/
template <class ResourceType, class ResourceInfo, class ResourceID, class ResourcePr = std::less<ResourceID> >
...
ResourceManager<ResourceType, ResourceInfo, ResourceID, ResourcePr>::~ResourceManager() 
{
...
*/
template <class ResourceType, class ResourceInfo, class ResourceID, class ResourcePr>
ResourceType& ResourceManager<ResourceType, ResourceInfo, ResourceID, ResourcePr>::operator[](const ResourceID& id) 
{
...
*/
template <class ResourceType, class ResourceInfo, class ResourceID, class ResourcePr>
const ResourceType& ResourceManager<ResourceType, ResourceInfo, ResourceID, ResourcePr>::operator[](const ResourceID& id) const 
{
...
*/
template <class ResourceType, class ResourceInfo, class ResourceID, class ResourcePr>
void ResourceManager<ResourceType, ResourceInfo, ResourceID, ResourcePr>::Destroy(const ResourceID& id)
{
...
*/
template <class ResourceType, class ResourceInfo, class ResourceID, class ResourcePr>
void ResourceManager<ResourceType, ResourceInfo, ResourceID, ResourcePr>::Add(const ResourceID& id, const ResourceType& resource) 
{
...
*/
template <class ResourceType, class ResourceInfo, class ResourceID, class ResourcePr>
void ResourceManager<ResourceType, ResourceInfo, ResourceID, ResourcePr>::Remove(const ResourceID& id) 
{
